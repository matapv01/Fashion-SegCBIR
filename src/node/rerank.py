...
def rerank(reranking_model, query_text: str, all_files: List[str], all_labels: List[str], candidate_indices: List[int], eval_mode: bool = False):
    ...
    final_indices = [idx for s, idx in filtered[:topn]]
